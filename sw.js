...
self.addEventListener('install', e => {
    ...
    const cacheInstallEstatico = caches.open(cache_estatico).then(cache => {
        ...
        return cache.addAll([
            ...
            'pages/Nosotros.html',
            'pages/Offline.html',
            '/Imagenes/noimage.jpg',
            '/manifest.json',
            '/js/app.js',    
            '/Imagenes/Ada1.jpeg',
            '/Imagenes/Ada2.png',
            '/Imagenes/Ada3.jpeg',
            '/Imagenes/Albert1.jpeg',
            '/Imagenes/Albert2.png',
            '/Imagenes/Albert3.png',
            '/Imagenes/Chris1.png',
            '/Imagenes/Chris2.png',
            '/Imagenes/Chris3.png',
            '/Imagenes/Claire1.jpeg',
            '/Imagenes/Claire2.jpeg',
            '/Imagenes/Claire3.jpeg',
            '/Imagenes/Jill1.jpeg',
            '/Imagenes/Jill2.jpeg',
            '/Imagenes/Jill3.jpg',
            '/Imagenes/LeonKennedy1.jpg',
            '/Imagenes/LeonKennedy2.jpg',
            '/Imagenes/LeonKennedy3.jpg',
